...
3. Add the templates from the *other* folder to the OpenShift project that provide
.
```
oc create -f other/jenkins-cluster-persistent-template.json,other/jenkins-cluster-ephemeral-template.json
```
